...
> Status: step 8 in progress — backend switched to FastAPI on 2026-09-13; milestone 1.0 restarting at 1.0.2. Steps 1–7 of 17 are done for the whole product (v1–v4) in the shared [project lifecycle](../PROCESS.md). One of six portfolio projects by [Viraj Domadia](https://virajdomadia.vercel.app). **Live (landing page):** https://tripsmith.vercel.app — will move to `tripsmith.virajdomadia.com` later.
...
api/        FastAPI (Python 3.12, uv) REST API — rebuilt from 1.0.2 onwards

    ...
    <section className="wrap hero">
      <div>
        <h1>
          ...
          <br />
          <em>It books the rest.</em>
        </h1>
        <p className="lede">
          Chat with a concierge that knows every package we run — dates, prices, what&apos;s
          included — and books the one that fits your budget.
        </p>
        <div className="cta">
          <a className="btn btn-sea" href="#">
            Plan a trip in chat
          </a>
      ...
      <div className="chat" aria-label="Example conversation with the concierge">
        <div className="chat-top">
          <span className="dot"></span> Tripsmith concierge
        </div>
        <div className="chat-body">
          <div className="msg user">3 days in Goa under ₹15k for two, next weekend</div>
          <div className="msg bot">
            Got it. Beach side or old-town side? And do you want breakfast included?
          </div>
          <div className="msg user">North Goa, breakfast yes</div>
          <div className="msg bot">
            Two packages fit. This one leaves the most room in your budget:
            <div className="itin">
              ...
              <div className="price">
                2 travellers · 19–21 Sep <span>₹13,400</span>
              </div>

    ...
    <section className="wrap owner" id="agency">
      <div className="owner-in">
        <div>
          ...
          <p>
            Add packages, set dates and prices, and watch bookings and payments land. The concierge
            reads from the same data, so what you publish is what it sells.
          </p>
          <ul>
        ...
        <div className="table" role="table" aria-label="Recent bookings">
          ...
          <div className="row" role="row">
            ...
            <span>Rohit &amp; Meera</span>
            <span>3–6 Oct</span>
            <span className="pill">Paid</span>
          </div>
          <div className="row" role="row">
            <span>Manali long weekend</span>
            <span>Karan S.</span>
            <span>10–14 Oct</span>
            <span className="pill wait">Awaiting payment</span>
          </div>
          <div className="row" role="row">
            <span>Jaisalmer desert</span>
            <span>Priya D.</span>
            <span>24–26 Oct</span>
            <span className="pill">Paid</span>
          </div>

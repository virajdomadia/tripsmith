"""`/account/*` for a signed-in customer (R18, R19): My trips, one booking, and the request to
cancel it. The voucher download lives beside the signed link in vouchers.py."""

...
**TBT was never tuned.** The home page ships ~193 kB of first-load JavaScript and the sub-score sat at 0.78. It is the one performance risk v1 leaves open, and the candidates are known (the home search bar and the listing filter panel hydrating on the main thread).

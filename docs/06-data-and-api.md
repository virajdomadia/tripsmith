...
| v2          | `GET /admin/bookings[.csv]` · `GET /admin/bookings/:ref` · `POST /admin/bookings/:ref/mark-paid` · `POST /admin/bookings/:ref/release` · `PATCH /admin/bookings/:ref/status` · `POST /admin/cancellations/:id/resolve` · `POST /admin/enquiries/:id/reply` · `PATCH /admin/reviews/:id` · `GET /admin/departures/:id/manifest`                                     | admin v2                                   | owner                                 |
